...
namespace DiscordBot2
{
    ...
    {
        public IConfigurationRoot Configuartion { get; }
        ...
        private void ConfigureServices(IServiceCollection services)
        {
            ...
            .AddSingleton(new CommandService(new CommandServiceConfig { LogLevel = Discord.LogSeverity.Verbose, DefaultRunMode = RunMode.Async, CaseSensitiveCommands = false }))
            .AddSingleton<CommandHandler>()
            .AddSingleton<StartupService>()
            .AddSingleton(Configuartion);
        }
    }
}
